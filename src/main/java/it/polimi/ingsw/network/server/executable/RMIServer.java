...
public class RMIServer implements Runnable {
    ...
    public void run() {
        ...
        ColorPrinter.log("creating RMI protocol implementation...");
        ...
        ColorPrinter.log("RMI implementation created");

        ColorPrinter.log("starting RMI registry...");
        ...
        ColorPrinter.log("binding RMI protocol implementation to registry...");
        ...
        ColorPrinter.log("RMI started on " + this.ipAddress + ":" + this.port);
        ColorPrinter.stat("RMI server is running...");
    }
}
